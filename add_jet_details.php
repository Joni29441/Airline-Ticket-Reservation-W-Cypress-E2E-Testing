...
<html>
	...
	<div class="card" style="margin:50px 130px">
		<div class="shadow p-4 mb-1 bg-body rounded">
			...
			<h2 class="title">Enter Aircraft Details</h2>
			...
			?>
			<div class="mb-3">
				<label for="formGroupExampleInput" class="form-label">Enter a Valid Aircraft ID</label>
				<input type="text" class="form-control" name="jet_id" required >
			</div>
			<br>
			<div class="mb-3">
				<label for="formGroupExampleInput" class="form-label">Enter the Aircraft Type/Model</label>
				<input type="text" class="form-control" name="jet_type" required >
			</div>
			<br>
			<div class="mb-3">
				<label for="formGroupExampleInput" class="form-label">Enter the total capacity of the Aircraft</label>
				<input type="text" class="form-control" name="jet_capacity" required >
			</div>
			<br>
			<br>
