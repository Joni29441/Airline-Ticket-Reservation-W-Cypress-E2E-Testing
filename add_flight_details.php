	...
	<div class="card" style="margin:50px 130px">
			<div class="shadow p-4 mb-1 bg-body rounded">
				<form action="add_flight_details_form_handler.php" method="post">
					...
					?>
					<div class="mb-3">
						<label for="formGroupExampleInput" class="form-label">Enter Flight Number</label>
					...
					<div class="row">
						...
						<label for="formGroupExampleInput">Arrival Date</label>
							<input type="date" class="form-control" name="arr_date" required>
						</div>
					</div>
					<br>
					<hr>
					<div class="row">
						<div class="col">
						<label for="formGroupExampleInput">Departure Time</label>
							<input type="time" class="form-control" name="dep_time" required>
						</div>
						<div class="col">
						<label for="formGroupExampleInput">Arrival Time</label>
					...
					<div class="row">
						<div class="col">
						<label for="formGroupExampleInput">Number of Seats in Economy Class</label>
							<input type="number" class="form-control"  name="seats_eco" required>
						</div>
						<div class="col">
						<label for="formGroupExampleInput">Number of Seats in Business Class</label>
							<input type="number" class="form-control" name="seats_bus" required>
						</div>
					</div>
					<br>
					<div class="row">
						<div class="col">
						<label for="formGroupExampleInput">Ticket Price(Economy Class)</label>
							<input type="number" class="form-control"  name="price_eco" required>
						</div>
						<div class="col">
						<label for="formGroupExampleInput">Ticket Price(Business Class)</label>
							<input type="number" class="form-control" name="price_bus" required>
						</div>
					</div>
					<br>
					<div class="mb-3">
						<label for="formGroupExampleInput" class="form-label">Enter Aircraft ID </label>
						<input type="text" class="form-control" name="jet_id" required >
					</div>	
