...
<html>
	...
	<div class="card" style="margin:50px 230px">
			...
			<form action="admin_view_booked_tickets_form_handler.php" method="post">
				<h2 class="title">View List Of Booked Tickets For a Flight</h2>
				<div class="mb-3">
					<label for="formGroupExampleInput" class="form-label">Enter The Flight Number</label>
					<input type="text" class="form-control" name="flight_no" required placeholder="Flight Number Goes Here">
				</div>
				<div class="mb-3">
					<label for="formGroupExampleInput" class="form-label">Enter The Departure Date</label>
